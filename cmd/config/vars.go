...
var (
	...
	//   -X 'github.com/0xMorph3us/bloodhound-cli/cmd/config.Version=`git describe --tags --abbrev=0`' \
	//   -X 'github.com/0xMorph3us/bloodhound-cli/cmd/config.BuildDate=`date -u '+%d %b %Y'`'" \
